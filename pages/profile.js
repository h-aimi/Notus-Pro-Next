    ...
    <>
      <div className="profile-container10">
        ...
        <div className="profile-image1">
          <Header></Header>
          <img alt="image" src="/gray-vector.svg" className="profile-image2" />
        ...
        <div className="profile-container11">
          ...
          <div className="profile-container16">
            <h3 className="profile-text1 Text2XL">Jenna Stones</h3>
            ...
            <div className="profile-container19">
              <div className="profile-container20">
                ...
                <span className="profile-text4 TextSM">
                  University of Computer Science
                </span>
              </div>
            </div>
            <div className="profile-container21"></div>
