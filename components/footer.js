      ...
      <div className="footer-container10">
        <div className="footer-container11">
          <div className="footer-container12">
            <h1 className="footer-text10 TextXL">
          ...
          <div className="footer-container18">
            <div className="footer-container19">
              <span className="footer-text13 TextXS">USEFUL LINK</span>
              <span className="footer-text14 TextSM">About Us</span>
              <span className="footer-text15 TextSM">Blog</span>
              <span className="footer-text16 TextSM">Github</span>
              <span className="footer-text17 TextSM">Free Products</span>
            </div>
            <div className="footer-container20">
              <span className="footer-text18 TextXS">OTHER RESOURCES</span>
              <span className="footer-text19 TextSM">License</span>
              <span className="footer-text20 TextSM">
                Terms &amp; Conditions
              </span>
              <span className="footer-text21 TextSM">Privacy Policy</span>
              <span className="footer-text22 TextSM">Contact Us</span>
            </div>
          </div>
        </div>
